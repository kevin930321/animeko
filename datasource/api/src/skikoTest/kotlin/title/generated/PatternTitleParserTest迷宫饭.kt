...
public class PatternTitleParserTest迷宫饭 : PatternBasedTitleParserTestSuite() {
  ...
  public fun `670479_1_Dungeon_Meshi_21_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【21】【GB_MP4】【1920X1080】")
    assertEquals("21..21", r.episodeRange.toString())
  ...
  public fun `670474_1_Dungeon_Meshi_21_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【21】【GB_MP4】【1280X720】")
    assertEquals("21..21", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `670438_Dungeon_Meshi_20_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [20][簡體雙語][1080p]招募翻譯")
  ...
  public fun `670199_Dungeon_Meshi_20_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [20][1080p][簡繁內封]")
    assertEquals("20..20", r.episodeRange.toString())
  ...
  public fun `670197_Dungeon_Meshi_20_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [20][1080p][簡體內嵌]")
    assertEquals("20..20", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 20 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("20..20", r.episodeRange.toString())
  ...
  public fun `670076_01_Dungeon_Meshi_Delicious_in_Dungeon_20_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][20][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("20..20", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `669907_1_Dungeon_Meshi_20_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【20】【GB_MP4】【1920X1080】")
    assertEquals("20..20", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `669905_1_Dungeon_Meshi_20_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【20】【GB_MP4】【1280X720】")
    assertEquals("20..20", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `669845_Dungeon_Meshi_19_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [19][簡體雙語][1080p]招募翻譯")
  ...
  public fun `669844_Dungeon_Meshi_18_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [18][簡體雙語][1080p]招募翻譯")
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 19v2 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("19..19", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `669295_01_Dungeon_Meshi_Delicious_in_Dungeon_19_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][19][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("19..19", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `669290_Dungeon_Meshi_19_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [19][1080p][簡繁內封]")
    assertEquals("19..19", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `669288_Dungeon_Meshi_19_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [19][1080p][簡體內嵌]")
    assertEquals("19..19", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `669201_1_Dungeon_Meshi_19_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【19】【GB_MP4】【1920X1080】")
    assertEquals("19..19", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `669199_1_Dungeon_Meshi_19_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【19】【GB_MP4】【1280X720】")
    assertEquals("19..19", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668901_Dungeon_Meshi_18_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [18][1080p][簡繁內封]")
    assertEquals("18..18", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `668899_Dungeon_Meshi_18_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [18][1080p][簡體內嵌]")
    assertEquals("18..18", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `668763_Dungeon_Meshi_17_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][17][x264 1080p][CHT]")
  ...
  public fun `668762_Dungeon_Meshi_17_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][17][x264 1080p][CHS]")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 18 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("18..18", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `668721_01_Dungeon_Meshi_Delicious_in_Dungeon_18_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][18][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("18..18", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668697_Dungeon_Meshi_16_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [17][簡體雙語][1080p]招募翻譯")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668637_1_Dungeon_Meshi_18_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【18】【GB_MP4】【1920X1080】")
    assertEquals("18..18", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668635_1_Dungeon_Meshi_18_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【18】【GB_MP4】【1280X720】")
    assertEquals("18..18", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668567_Dungeon_Meshi_17v2_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [17v2][1080p][簡繁內封]")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `668565_Dungeon_Meshi_17v2_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [17v2][1080p][簡體內嵌]")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 17 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `668278_01_Dungeon_Meshi_Delicious_in_Dungeon_17_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][17][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668195_1_Dungeon_Meshi_17_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【17】【GB_MP4】【1920X1080】")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668190_1_Dungeon_Meshi_17_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【17】【GB_MP4】【1280X720】")
    assertEquals("17..17", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668183_Dungeon_Meshi_16_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [16][簡體雙語][1080p]招募翻譯")
  ...
  public fun `668060_DBD_Raws_Dungeon_Meshi_01_06TV_BOX1_1080P_BDRip_HEVC_10bit_FLAC_MKV`() {
    kotlin.run {
    val r =
        parse("[DBD-Raws][迷宮飯/Dungeon Meshi/ダンジョン飯][01-06TV+特典映像][BOX1][1080P][BDRip][HEVC-10bit][FLAC][MKV]")
  ...
  public fun `668029_Dungeon_Meshi_16_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][16][x264 1080p][CHT]")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `668028_Dungeon_Meshi_16_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][16][x264 1080p][CHS]")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `667774_Dungeon_Meshi_16_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [16][1080p][簡繁內封]")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `667771_Dungeon_Meshi_16_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [16][1080p][簡體內嵌]")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 16 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `667703_01_Dungeon_Meshi_Delicious_in_Dungeon_16_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][16][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `667604_1_Dungeon_Meshi_16_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【16】【GB_MP4】【1920X1080】")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `667595_1_Dungeon_Meshi_16_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【16】【GB_MP4】【1280X720】")
    assertEquals("16..16", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `667535_Dungeon_Meshi_15_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [15][簡體雙語][1080p]招募翻譯")
  ...
  public fun `667474_Dungeon_Meshi_15_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][15][x264 1080p][CHT]")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `667473_Dungeon_Meshi_15_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][15][x264 1080p][CHS]")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `667445_Dungeon_Meshi_14_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [14][簡體雙語][1080p]招募翻譯")
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 15 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `667249_Dungeon_Meshi_15_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [15][1080p][簡繁內封]")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `667248_Dungeon_Meshi_15_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [15][1080p][簡體內嵌]")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `667125_1_Dungeon_Meshi_06_1080P_MP4`() {
    kotlin.run {
    val r = parse("[愛戀字幕社][1月新番][迷宮飯][Dungeon Meshi][06][1080P][MP4][簡日雙語]")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `667027_01_Dungeon_Meshi_Delicious_in_Dungeon_15_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][15][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666937_1_Dungeon_Meshi_15_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【15】【GB_MP4】【1920X1080】")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666935_1_Dungeon_Meshi_15_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【15】【GB_MP4】【1280X720】")
    assertEquals("15..15", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666874_Dungeon_Meshi_14_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][14][x264 1080p][CHT]")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666873_Dungeon_Meshi_14_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][14][x264 1080p][CHS]")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666871_Dungeon_Meshi_13_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][13][x264 1080p][CHT]")
  ...
  public fun `666870_Dungeon_Meshi_13_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][13][x264 1080p][CHS]")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666365_Dungeon_Meshi_14_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [14][1080p][簡繁內封]")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `666363_Dungeon_Meshi_14_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [14][1080p][簡體內嵌]")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `666360_Dungeon_Meshi_13_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [13][簡體雙語][1080p]招募翻譯")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 14 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `666242_01_Dungeon_Meshi_Delicious_in_Dungeon_14_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][14][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666135_1_Dungeon_Meshi_14_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【14】【GB_MP4】【1920X1080】")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `666133_1_Dungeon_Meshi_14_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【14】【GB_MP4】【1280X720】")
    assertEquals("14..14", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665797_Dungeon_Meshi_12_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [12][簡體雙語][1080p]招募翻譯")
  ...
  public fun `665785_Dungeon_Meshi_12_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][12][x264 1080p][CHT]")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665784_Dungeon_Meshi_12_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][12][x264 1080p][CHS]")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665781_Dungeon_Meshi_13_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [13][1080p][簡繁內封]")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `665779_Dungeon_Meshi_13_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [13][1080p][簡體內嵌]")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 13 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `665726_01_Dungeon_Meshi_Delicious_in_Dungeon_13_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][13][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665684_1_Dungeon_Meshi_13_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【13】【GB_MP4】【1920X1080】")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665682_1_Dungeon_Meshi_13_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【13】【GB_MP4】【1280X720】")
    assertEquals("13..13", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665621_Dungeon_Meshi_11_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [11][簡體雙語][1080p]招募翻譯")
  ...
  public fun `665570_1_Dungeon_Meshi_05_1080P_MP4`() {
    kotlin.run {
    val r = parse("[愛戀字幕社][1月新番][迷宮飯][Dungeon Meshi][05][1080P][MP4][簡日雙語]")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665463_Dungeon_Meshi_12_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [12][1080p][簡繁內封]")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `665460_Dungeon_Meshi_12_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [12][1080p][簡體內嵌]")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `665345_1_Dungeon_Meshi_04_1080P_MP4`() {
    kotlin.run {
    val r = parse("[愛戀字幕社][1月新番][迷宮飯][Dungeon Meshi][04][1080P][MP4][簡日雙語]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 12 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `665310_01_Dungeon_Meshi_Delicious_in_Dungeon_12_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][12][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665238_1_Dungeon_Meshi_12_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【12】【GB_MP4】【1280X720】")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665237_1_Dungeon_Meshi_12_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【12】【GB_MP4】【1920X1080】")
    assertEquals("12..12", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665136_Dungeon_Meshi_11_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][11][x264 1080p][CHT]")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `665135_Dungeon_Meshi_11_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][11][x264 1080p][CHS]")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664998_Dungeon_Meshi_11_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [11][1080p][簡繁內封]")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `664996_Dungeon_Meshi_11_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [11][1080p][簡體內嵌]")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 11 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `664885_01_Dungeon_Meshi_Delicious_in_Dungeon_11_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][11][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664849_1_Dungeon_Meshi_11_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【11】【GB_MP4】【1920X1080】")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664847_1_Dungeon_Meshi_11_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【11】【GB_MP4】【1280X720】")
    assertEquals("11..11", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664840_Dungeon_Meshi_10_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [10][簡體雙語][1080p]招募翻譯")
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 10 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `664728_Dungeon_Meshi_10_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [10][1080p][簡繁內封]")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `664726_Dungeon_Meshi_10_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [10][1080p][簡體內嵌]")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `664722_1_Dungeon_Meshi_03_1080P_MP4`() {
    kotlin.run {
    val r = parse("[愛戀字幕社][1月新番][迷宮飯][Dungeon Meshi][03][1080P][MP4][簡日雙語]")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664505_Dungeon_Meshi_10_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][10][x264 1080p][CHT]")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664504_Dungeon_Meshi_10_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][10][x264 1080p][CHS]")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664468_01_Dungeon_Meshi_Delicious_in_Dungeon_10_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][10][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664426_1_Dungeon_Meshi_10_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【10】【GB_MP4】【1920X1080】")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664423_1_Dungeon_Meshi_10_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【10】【GB_MP4】【1280X720】")
    assertEquals("10..10", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664299_Dungeon_Meshi_09_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [09][簡體雙語][1080p]招募翻譯")
  ...
  public fun `664298_Dungeon_Meshi_08_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [08][簡體雙語][1080p]招募翻譯")
  ...
  public fun `664288_1_Dungeon_Meshi_02_1080P_MP4`() {
    kotlin.run {
    val r = parse("[愛戀字幕社][1月新番][迷宮飯][Dungeon Meshi][02][1080P][MP4][簡日雙語]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `664165_Dungeon_Meshi_07_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [07][簡體雙語][1080p]招募翻譯")
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 09 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `663992_Dungeon_Meshi_09_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [09][1080p][簡繁內封]")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `663990_Dungeon_Meshi_09_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [09][1080p][簡體內嵌]")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `663949_Dungeon_Meshi_09_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][09][x264 1080p][CHT]")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663948_Dungeon_Meshi_09_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][09][x264 1080p][CHS]")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663877_01_Dungeon_Meshi_Delicious_in_Dungeon_09_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][09][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663856_1_Dungeon_Meshi_09_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【09】【GB_MP4】【1920X1080】")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663854_1_Dungeon_Meshi_09_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【09】【GB_MP4】【1280X720】")
    assertEquals("09..09", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663851_Dungeon_Meshi_06_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [06][簡體雙語][1080p]招募翻譯")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663602_Dungeon_Meshi_08_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][08][x264 1080p][CHT]")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663601_Dungeon_Meshi_08_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][08][x264 1080p][CHS]")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663572_Dungeon_Meshi_08_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [08][1080p][簡繁內封]")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `663570_Dungeon_Meshi_08_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [08][1080p][簡體內嵌]")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 08 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `663374_01_Dungeon_Meshi_Delicious_in_Dungeon_08_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][08][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663349_1_Dungeon_Meshi_08_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【08】【GB_MP4】【1920X1080】")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663347_1_Dungeon_Meshi_08_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【08】【GB_MP4】【1280X720】")
    assertEquals("08..08", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663133_Dungeon_Meshi_07_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][07][x264 1080p][CHS]")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663132_Dungeon_Meshi_07_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][07][x264 1080p][CHT]")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `663106_Dungeon_Meshi_07_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [07][1080p][簡繁內封]")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `663104_Dungeon_Meshi_07_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [07][1080p][簡體內嵌]")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `662977_1_Dungeon_Meshi_01_1080P_MP4`() {
    kotlin.run {
    val r = parse("[愛戀字幕社][1月新番][迷宮飯][Dungeon Meshi][01][1080P][MP4][簡日雙語]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 07 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `662906_01_Dungeon_Meshi_Delicious_in_Dungeon_07_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][07][1080p][簡日雙語][招募翻譯時軸]")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662861_1_Dungeon_Meshi_07_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【07】【GB_MP4】【1920X1080】")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662856_1_Dungeon_Meshi_07_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【07】【GB_MP4】【1280X720】")
    assertEquals("07..07", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662800_Dungeon_Meshi_06_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [06][1080p][簡繁內封]")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `662798_Dungeon_Meshi_06_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [06][1080p][簡體內嵌]")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `662690_Dungeon_Meshi_06_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][06][x264 1080p][CHT]")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662689_Dungeon_Meshi_06_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][06][x264 1080p][CHS]")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 06 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `662498_01_Dungeon_Meshi_Delicious_in_Dungeon_06_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][06][1080p][簡日雙語][招募翻譯]")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662373_1_Dungeon_Meshi_06_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【06】【GB_MP4】【1920X1080】")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662370_1_Dungeon_Meshi_06_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【06】【GB_MP4】【1280X720】")
    assertEquals("06..06", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662317_Dungeon_Meshi_05_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [05][簡體雙語][1080p]招募翻譯")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662096_Dungeon_Meshi_05_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [05][1080p][簡繁內封]")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `662094_Dungeon_Meshi_05_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [05][1080p][簡體內嵌]")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `662083_Dungeon_Meshi_05_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][05][x264 1080p][CHT]")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `662082_Dungeon_Meshi_05_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][05][x264 1080p][CHS]")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 05 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `661958_01_Dungeon_Meshi_Delicious_in_Dungeon_05_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][05][1080p][簡日雙語][招募翻譯]")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661904_1_Dungeon_Meshi_05_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【05】【GB_MP4】【1920X1080】")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661903_1_Dungeon_Meshi_05_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【05】【GB_MP4】【1280X720】")
    assertEquals("05..05", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661841_Dungeon_Meshi_04_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [04][簡體雙語][1080p]招募翻譯")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661672_Dungeon_Meshi_04_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [04][1080p][簡繁內封]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `661670_Dungeon_Meshi_04_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [04][1080p][簡體內嵌]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `661648_Dungeon_Meshi_04_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][04][x264 1080p][CHS]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661647_Dungeon_Meshi_04_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][04][x264 1080p][CHT]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 04v2 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 04 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `661469_01_Dungeon_Meshi_Delicious_in_Dungeon_04_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][04][1080p][簡日雙語][招募翻譯]")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661436_1_Dungeon_Meshi_04_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【04】【GB_MP4】【1920X1080】")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661433_1_Dungeon_Meshi_04_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【04】【GB_MP4】【1280X720】")
    assertEquals("04..04", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661307_Dungeon_Meshi_03_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [03][簡體雙語][1080p]招募翻譯")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661184_Dungeon_Meshi_03_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][03][x264 1080p][CHT]")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661183_Dungeon_Meshi_03_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][03][x264 1080p][CHS]")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661182_Dungeon_Meshi_02_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][02][x264 1080p][CHT]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661181_Dungeon_Meshi_02_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("【悠哈璃羽字幕社】[迷宮飯/Dungeon Meshi][02][x264 1080p][CHS]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `661103_Dungeon_Meshi_03_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [03][1080p][簡繁內封]")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `661101_Dungeon_Meshi_03_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [03][1080p][簡體內嵌]")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 03 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `660888_01_Dungeon_Meshi_Delicious_in_Dungeon_03_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][03][1080p][簡日雙語][招募翻譯]")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660876_1_Dungeon_Meshi_03_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【03】【GB_MP4】【1920X1080】")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660874_1_Dungeon_Meshi_03_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【03】【GB_MP4】【1280X720】")
    assertEquals("03..03", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660861_Dungeon_Meshi_02_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [02][簡體雙語][1080p]招募翻譯")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660760_Dungeon_Meshi_02_1080p_2024_1`() {
    kotlin.run {
    val r = parse("[擺爛字幕組＆獵戶譯製部] 迷宮飯 / Dungeon Meshi [02] [1080p] [繁日內嵌] [2024年1月番]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `660759_Dungeon_Meshi_02_1080p_2024_1`() {
    kotlin.run {
    val r = parse("[擺爛字幕組＆獵戶譯製部] 迷宮飯 / Dungeon Meshi [02] [1080p] [簡日內嵌] [2024年1月番]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `660539_Dungeon_Meshi_02_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [02][1080p][簡繁內封]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `660537_Dungeon_Meshi_02_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [02][1080p][簡體內嵌]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `660374_Dungeon_Meshi_01_1080p`() {
    kotlin.run {
    val r = parse("[雲光字幕組] 迷宮飯 Dungeon Meshi [01][簡體雙語][1080p]招募翻譯")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 02 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `660339_01_Dungeon_Meshi_Delicious_in_Dungeon_02_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][02][1080p][簡日雙語][招募翻譯]")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660325_1_Dungeon_Meshi_02_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【02】【GB_MP4】【1920X1080】")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660323_1_Dungeon_Meshi_02_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【02】【GB_MP4】【1280X720】")
    assertEquals("02..02", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660128_Dungeon_Meshi_01_x264_1080p_CHS`() {
    kotlin.run {
    val r = parse("[悠哈璃羽字幕社][迷宮飯/Dungeon Meshi][01][x264 1080p][CHS]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660127_Dungeon_Meshi_01_x264_1080p_CHT`() {
    kotlin.run {
    val r = parse("[悠哈璃羽字幕社][迷宮飯/Dungeon Meshi][01][x264 1080p][CHT]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `660105_Dungeon_Meshi_01_1080p_2024_1`() {
    kotlin.run {
    val r = parse("[擺爛字幕組＆獵戶譯製部] 迷宮飯 / Dungeon Meshi [01] [1080p] [簡日內嵌] [2024年1月番]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public
    ...
    kotlin.run {
    val r =
        parse("[喵萌奶茶屋&LoliHouse] 迷宮飯 / Dungeon Meshi / Delicious in Dungeon - 01 [WebRip 1080p HEVC-10bit AAC EAC3][簡繁日內封字幕]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `659971_Dungeon_Meshi_01_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [01][1080p][簡繁內封]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.CLOSED, r.subtitleKind)
  ...
  public fun `659969_Dungeon_Meshi_01_1080p`() {
    kotlin.run {
    val r = parse("[桜都字幕組] 迷宮飯 / Dungeon Meshi [01][1080p][簡體內嵌]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(SubtitleKind.EMBEDDED, r.subtitleKind)
  ...
  public fun `659932_1_Dungeon_Meshi_01v2_GB_MP4_1920X1080`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【01v2】【GB_MP4】【1920X1080】")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `659930_1_Dungeon_Meshi_01v2_GB_MP4_1280X720`() {
    kotlin.run {
    val r = parse("【幻櫻字幕組】【1月新番】【迷宮飯 Dungeon Meshi】【01v2】【GB_MP4】【1280X720】")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("720P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
  ...
  public fun `659915_01_Dungeon_Meshi_Delicious_in_Dungeon_01_1080p`() {
    kotlin.run {
    val r =
        parse("【喵萌奶茶屋】★01月新番★[迷宮飯 / Dungeon Meshi / Delicious in Dungeon][01][1080p][簡日雙語][招募翻譯]")
    assertEquals("01..01", r.episodeRange.toString())
    assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    assertEquals("1080P", r.resolution.toString())
    assertEquals(null, r.subtitleKind)
