...
sealed class SubtitleLanguage(
    ...
    object ChineseCantonese : Chinese("CHC", "粵語") {
        private val tokens = arrayOf("粵", "粵", "Cantonese", "CHC", "Yue")
        override fun matches(text: String): Boolean {
            return tokens.any { text.contains(it, ignoreCase = true) }
        }
    }

    object ChineseSimplified : Chinese("CHS", "簡中") {
        private val tokens =
            arrayOf(
                "簡中",
                "GB",
    ...
    object Japanese : SubtitleLanguage("JPN", "日語") {
    ...
    object English : SubtitleLanguage("ENG", "英語") {
