...
class TimeFormatter(
    ...
    fun format(instant: Instant, showTime: Boolean = true): String {
        ...
        return when (val differenceInSeconds = (now - instant).inWholeSeconds) {
            ...
            in -60..0 -> "${-differenceInSeconds} 秒後"
            in 60..<3600 -> "${differenceInSeconds / 60} 分鐘前"
            in -3600..-60 -> "${-differenceInSeconds / 60} 分鐘後"
            in 3600..<86400 -> "${differenceInSeconds / 3600} 小時前"
            in -86400..<-3600 -> "${-differenceInSeconds / 3600} 小時後"
            in 86400..<86400 * 2 -> "${differenceInSeconds / 86400} 天前"
            in -86400 * 2..<-86400 -> "${-differenceInSeconds / 86400} 天後"
