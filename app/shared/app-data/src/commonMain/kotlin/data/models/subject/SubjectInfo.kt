...
val TestSubjectInfo
    get() = SubjectInfo.Empty.copy(
        ...
        summary = """
        作為網路吉他手「吉他英雄」而廣受好評的後藤一里，在現實中卻是個什麼都不會的溝通障礙者。一里有著組建樂團的夢想，但因為不敢向人主動搭話而一直沒有成功，直到一天在公園中被伊地知虹夏發現並邀請進入缺少吉他手的「結束樂團」。可是，完全沒有和他人合作經歷的一里，在人前完全發揮不出原本的實力。為了努力克服溝通障礙，一里與「結束樂團」的成員們一同開始努力……
    """.trimIndent(),
        tags = listOf(
            Tag("芳文社", 7098),
            Tag("音樂", 5000),
